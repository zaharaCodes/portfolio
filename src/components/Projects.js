...
const projectVisuals = {
  1: <BsRobot size={80} />,
  2: <BsPeopleFill size={80} />,
  3: <BsKanbanFill size={80} />,
  4: <BsHeartPulseFill size={80} />,
  5: <BsFlower1 size={80} />,
};
...
const DeploymentBadges = ({ project }) => {
  ...
  if (deployment.backend?.includes('Docker')) {
    return (
      <div style={{ marginBottom: '18px' }}>
        <span style={{ fontSize: '11px', padding: '4px 12px', borderRadius: '999px', background: `${color}15`, border: `1px solid ${color}40`, color: color, display: 'flex', alignItems: 'center', gap: '5px', width: 'fit-content' }}>
        ...
        >
            ...
            {project.video ? (
              ...
              <>
                <div style={{
                  ...
                  backgroundImage: `radial-gradient(circle at 40% 50%, ${project.color}50 0%, transparent 60%)`,
                }} />
                <div style={{
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    background: 'rgba(0,0,0,0.5)', padding: '5px 16px',
                ...
                {project.id === 5 && (
                  <div style={{
                    ...
                    background: `${project.color}25`, border: `1px solid ${project.color}60`,
          ...
          <div style={{ padding: '32px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px', marginBottom: '16px' }}>
              <h2 style={{ fontSize: '26px', fontWeight: 700, color: project.color, margin: 0, lineHeight: 1.3 }}>
                {project.title}
              </h2>
...
// ─── PROJECT CARD (grid card - compact) ─────────────────────────────────────
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: `radial-gradient(circle at 40% 50%, ${project.color}40 0%, transparent 60%)`,
        }} />
        <div style={{
          position: 'absolute', inset: 0,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <motion.div
            animate={hovered ? { y: [-4, 4, -4], rotate: [0, 5, -5, 0] } : { y: 0 }}
            transition={{ duration: 2, repeat: hovered ? Infinity : 0 }}
            style={{
              color: project.color,
              filter: hovered ? `drop-shadow(0 0 20px ${project.color})` : 'none',
              transition: 'filter 0.3s',
            }}
          >
            {React.cloneElement(projectVisuals[project.id], { size: 60 })}
          </motion.div>
        </div>
        ...
        {project.id === 5 && (
          <div style={{
            ...
            background: `${project.color}25`, border: `1px solid ${project.color}60`,
            color: project.color, fontSize: '10px', fontWeight: 600,
          }}>
            📄 Published
          </div>
        )}
      ...
      <div style={{ padding: '20px' }}>
        <h3 style={{
          ...
          margin: '0 0 8px 0', transition: 'color 0.3s',
          lineHeight: 1.3,
        }}>
          {project.title}
        </h3>
