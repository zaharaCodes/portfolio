    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          {project.video ? (
            <>
              {/* VIDEO - no overlays so it shows clearly */}
              <video
                ref={videoRef}
                src={project.video}
                muted
              ...
              {/* Only LIVE badge - no dark overlay */}
              <div style={{
                position: 'absolute',
                top: 12,
                right: 12,
            ...
            <>
              ...
              <div style={{
                ...
                <motion.div
                  ...
                  style={{
                    color: project.color,
                    filter: `drop-shadow(0 0 24px ${project.color})`,
                  }}
                >
        ...
        <div style={{
            ...
            <div style={{
              ...
              {project.deployment.frontend ? (
                ...
                <span style={{
                  ...
                  <SiRender size={10} />
                  Deployed on {project.deployment.backend}
                </span>
              )}
            </div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <motion.button
              onClick={() =>
                setExpandedStory(isExpanded ? null : project.id)
              }
              style={{
                display: 'flex',
                alignItems: 'center',
